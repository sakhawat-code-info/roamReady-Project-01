            ...
            <article className="px-4 py-24 mx-auto max-w-7xl" >
                <div className="w-full mx-auto mb-10 text-left md:w-3/4 lg:w-1/2">
                    ...
                    <div className="pb-6 mb-6 border-b border-gray-200">
                        <h1 className="mb-1 text-3xl font-bold text-gray-900 md:leading-tight md:text-4xl" title="Rise of Tailwind - A Utility First CSS Framework">
                            Dhaka hatir zil
                        </h1>
                        <h1 className="mb-3 text-xl font-bold text-gray-900 md:leading-tight md:text-xl" title="">
                            Bangladesh
                        </h1>
                    ...
                    <img src="https://r2.erweima.ai/imgcompressed/compressed_0256073c49c71077d0e96e412aa4d94d.webp" className="object-cover w-full h-64 bg-center rounded" alt="Kutty" />


                    <div className="flex my-6 space-x-2">
                        <a className="text-gray-900 bg-gray-100 badge hover:bg-gray-200" href="#">Location</a>
                        <a className="text-gray-900 bg-gray-100 badge hover:bg-gray-200" href="#">Travel time</a>
                        <a className="text-gray-900 bg-gray-100 badge hover:bg-gray-200" href="#">Total visitor per year</a>
                        <a className="text-gray-900 bg-gray-100 badge hover:bg-gray-200" href="#">30000 tk</a>
                    </div>
                </div>
                ...
                <div className="w-full mx-auto prose md:w-3/4 lg:w-1/2">
                    ...
                    <p>Tailwind is a utility-first CSS framework, the keyword being ‘utility’. It is basically a set of classNamees that you can use in your HTML.</p>
